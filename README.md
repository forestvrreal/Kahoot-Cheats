...
This cheat allows users to gain an advantage in Kahoot by adding the provided Js code to a browser bookmark Once the bookmark is added it can be activated during gameplay providing a simple and user friendly way to access the functionality without installing additional software
...
3. Copy the provided Js code into the URL or location field of the bookmark
4. Name the bookmark so you can easily recognize it

## How to Use

1. Start a Kahoot Game
